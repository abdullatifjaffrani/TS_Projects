...
if (answer.operator === "Addition") {console.log(chalk.green (answer.FirstNumber + answer.SecondNumber))}

// This is for (Subtraction)
else if (answer.operator === "Subtraction") {console.log(chalk.yellow (answer.FirstNumber - answer.SecondNumber));
}

// This is for (Multiplication)
else if (answer.operator === "Multiplication") {console.log(chalk.blue (answer.FirstNumber * answer.SecondNumber));
}

// This is for (Divison)
else if (answer.operator === "Divison") {console.log(chalk.magenta (answer.FirstNumber / answer.SecondNumber));
}

// If nothing is Selected
else {console.log(chalk.bgRed.underline ("error, Please Select the Valid Operator"))}